...
public class ProductsForRemovingAdapter extends RecyclerView.Adapter<ProductsForRemovingAdapter.ProductViewHolder> implements Filterable {
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageButton editAllRecepyViewButton;
        private ImageButton removeAllRecepyViewButton;

        public ProductViewHolder(@NonNull View itemView, onClickListenerInterface onClickListenerInput) {
            super(itemView);
            productTextView = itemView.findViewById(R.id.allProductsTextView);
            editAllRecepyViewButton = itemView.findViewById(R.id.allProductsEditItem);
            removeAllRecepyViewButton = itemView.findViewById(R.id.allProductsDeleteItemForever);

            removeAllRecepyViewButton.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            editAllRecepyViewButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(onClickListenerInput != null)
                    {
    ...
    public ProductsForRemovingAdapter(List<ProductEntity> productEntityList)
    {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.all_products_card, viewGroup, false);
